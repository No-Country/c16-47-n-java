              ...
              <>
                ...
                <form action={(e) => Logear(e)}>
                  ...
                  <div className="mt-8 flex flex-col gap-y-4">
                    <button onClick={(e) => Logear(e)} type="submit" className="active:scale-[.98] hover:scale-[1.01] py-2 rounded-xl bg-[#74BB23] text-white text-lg font-bold">
                      Iniciar sesión
                    </button>
                  </div>
                </form>
          ...
          <div>
            <div className="bg-white px-10 py-10 rounded-3xl border-t-2 border-r-2 border-b-2 border-l-2 border-[#ff9a36] border-t-[#a1bb23] border-r-[#a1bb23] border-b-[#ff9a36] border-form">
              <form>
                ...
                <div className="mt-8 flex flex-col gap-y-4">
                  <button onClick={(e) => Logear(e)} type="submit"
