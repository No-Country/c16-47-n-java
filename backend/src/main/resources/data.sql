...
VALUES ('Av. Rivadavia 1234, Buenos Aires', '555-1234', 'juanmartinez@hotmail.com', 'admin123', 'ADMIN',
        'Juan Martínez'),
       ('Av. Corrientes 5678, Córdoba', '555-5678', 'gomezmaria@gmail.com', 'user123', 'USER', 'María Gómez');

INSERT INTO `product_tbl` (`category`, `description`, `image_url`, `name`, `price`, `stock`)
VALUES ('FRUTAS', 'Manzanas frescas y jugosas', 'manzanas.jpg', 'Manzanas Gala', 2.5, 50),
